...
export const BIBLE_VERSE_COUNTS: Record<string, number[]> = {
  ...
  // Samuel Combined (1 Sam 31 + 2 Sam 24)
  "Samuel": [
    28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24, 42, 15, 23, 29, 22, 44, 25, 12, 25, 11, 31, 13, // 1 Sam
    27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37, 23, 29, 33, 43, 26, 22, 51, 39, 25 // 2 Sam
  ],
  // Kings Combined (1 Kings 22 + 2 Kings 25)
  "Kings": [
    53, 46, 28, 34, 18, 38, 51, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 43, 29, 53, // 1 Kings
    18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 21, 25, 29, 38, 20, 41, 37, 18, 21, 26, 20, 37, 20, 30 // 2 Kings
  ],
  ...
  // Chronicles Combined (1 Chron 29 + 2 Chron 36)
  "Chronicles": [
    54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 47, 40, 14, 17, 29, 43, 27, 17, 19, 8, 30, 19, 32, 31, 31, 32, 34, 21, 30, // 1 Chron
    17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 22, 15, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 33, 25, 33, 27, 23 // 2 Chron
  ],
